// Taken from https://github.com/microsoft/vscode/blob/main/extensions/markdown-language-features/src/logger.ts
...
export class Logger {
  ...
  private readonly outputChannel = lazy(() =>
    vscode.window.createOutputChannel("Kaitai Struct IDE")
  );
  ...
  private readTrace(): Trace {
    return Trace.fromString(
      vscode.workspace
        .getConfiguration()
        .get<string>("kaitaiStruct.trace", "off")
    );
  }
